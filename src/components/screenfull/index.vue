<template>
  <div class="screenfull-box">
    <svg t="1508738709248" @click="click" class="screenfull-svg box-center" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
      p-id="2069" xmlns:xlink="http://www.w3.org/1999/xlink" :width="width" :height="height">
  ...
  methods: {
    click() {
      if (!screenfull.enabled) {
        return this.$message.warning("浏览器不支持该功能！");
      }
      screenfull.toggle();
    }
  }
